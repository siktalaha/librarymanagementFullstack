    ...
    <div>
      ...
      <Row>
        ...
        <div className='shadow p-2'>
          <h1 className="text-secondary uppercase text-xl">
            Books
          </h1>
          <hr/>
          ...
          <div className="flex justify-between mt-1">
              ...
              <h1>{reports?.books?.avaliableBookCopiesCount}</h1>
            </div>
         ...
         <Col span={6}>
          <div className="shadow p-2">
            ...
            <div className="flex justify-between mt-1">
              ...
              <h1>{reports?.users?.librarianCount}</h1>
            </div>

            <div className="flex justify-between mt-1">
              <h1 className="text-md">Admins</h1>
              <h1>{reports?.users?.adminCount}</h1>
            </div>
          </div>
        </Col>
        ...
        <Col span={6}>
          <div className="shadow p-2">
            ...
            <div className="flex justify-between mt-1">
              ...
              <h1>{reports?.issues?. pendingIssueCount}</h1>
            </div>
