...
// //         <Col xs={24} sm={24} md={12}lg={12} xl={12} className='flex flex-column gap-2'>
// //         <h1 className='text-2xl text-secondary font-bold'>
// //             {bookData.title}
// //         </h1>
// //         <hr/>
// //         <img src={bookData.image} width={300}height={400}/>
// //          <p>
// //             {bookData.description}
// //          </p>
// //          <div className='flex justify-between'>
// //                 <h1 className='text-md'>Author:</h1><h1 className='text-md'>{bookData?.author}</h1>
// //             </div>
// //             <div className='flex justify-between'>
// //                 <h1 className='text-md'>Publisher</h1><h1 className='text-md'>{bookData?.publisher}</h1>
// //             </div>
// //             <div className='flex justify-between'>
// //                 <h1 className='text-md'>Publish Date</h1><h1 className='text-md'>{moment(bookData?.publishedDate).format('MMMM Do YYYY')}</h1>
// //             </div>
// //             <div className='flex justify-between'>
// //                 <h1 className='text-md'>Avaliable Copies</h1><h1 className='text-md'>{bookData?.avaliableCopies}</h1>
// //             </div>
    ...
    bookData && <div>
      <Row gutter={[16, 16]} align="middle" justify="center">
        ...
        >
          ...
          <div className="flex justify-between">
            <h1 className="text-md">Available Copies</h1>
            <h1 className="text-md">{bookData?.avaliableCopies}</h1>
          </div>
        </Col>
      </Row>
    </div>
